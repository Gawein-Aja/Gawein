        ...
        <aside className="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <section className="sidebar">
                <div className="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div className="image">
                        <img src={process.env.MIX_APP_URL + 'adminLTE/dist/img/avatar04.png'} className="img-circle elevation-2" alt="User Image" />
                    </div>
                    <div className="info">
                        <p href="#" className="mb-0 text-white-50 d-block">{User.name()}</p>
                    </div>
                </div>
                <nav className="mt-2">
                    <ul className="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        <li className="mb-3">
                            <span className="text-white-50">MAIN NAVIGATION</span>
                        </li>
                        ...
                        <li className="nav-item">
                            <Link className={props.location.pathname=='/posts'?'nav-link active':'nav-link'} to='/posts'>
                                <i className="nav-icon fa fa-th"></i> <span>Posts</span>
                            </Link>
                        </li>
                        {/*<li className="nav-item">*/}
